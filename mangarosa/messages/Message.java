...
public class Message implements Serializable, Comparable<Message> {
    ...
    /**
     * Verifica se a mensagem expirou (mais de 5 minutos desde sua criação).
     * @return true se a mensagem expirou, false caso contrário.
     */
    ...
    /**
     * Compara esta mensagem com outra.
     * @param other A outra mensagem a ser comparada.
