...
/**
 * A classe FastDeliveryConsumer implementa a interface Consumer,
 * sendo responsável por consumir mensagens enviadas para o tópico "queue/fast-delivery-items".
 */

public class FastDeliveryConsumer implements Consumer {
    private final String name = "FastDeliveryConsumer";
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            nextMessage.addConsumption(FastDeliveryConsumer.this);
