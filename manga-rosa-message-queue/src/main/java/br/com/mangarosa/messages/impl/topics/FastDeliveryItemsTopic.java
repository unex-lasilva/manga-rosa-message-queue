...
/**
 * A classe FastDeliveryItemsTopic representa um tópico para itens de entrega rápida,
 * permitindo a adição de mensagens e o gerenciamento de consumidores interessados
 * nas mensagens associadas a este tópico.
 */
public class FastDeliveryItemsTopic implements Topic {
    ...
    /**
     * Construtor da classe FastDeliveryItemsTopic.
     ...
     */
    public FastDeliveryItemsTopic(MessageRepository messageRepository){
