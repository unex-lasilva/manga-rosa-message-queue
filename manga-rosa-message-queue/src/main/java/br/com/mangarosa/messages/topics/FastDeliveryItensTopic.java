...
public class FastDeliveryItensTopic implements Topic {
    private final String name = "queue/fast-delivery-items";
    ...
    public void FastDeliveryItemsTopic(MessageRepository repository) {
