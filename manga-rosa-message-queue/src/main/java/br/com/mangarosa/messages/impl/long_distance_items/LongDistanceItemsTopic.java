package br.com.mangarosa.messages.impl.long_distance_items;
...
public class LongDistanceItemsTopic implements Topic {
    ...
    public LongDistanceItemsTopic(MesageRepository repository) {
        this.name = "queue/long-distance-consumer";
