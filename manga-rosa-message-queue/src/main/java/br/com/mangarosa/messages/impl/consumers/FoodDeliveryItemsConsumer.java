...
/**
 * Implementação de um consumidor para itens de entrega rápida.
 * Esse consumidor processa mensagens relacionadas a entregas rápidas.
 */
public class FoodDeliveryItemsConsumer implements Consumer {
    ...
    @Override
    public String name() {
        return "FoodDeliveryItemsConsumer";
    }
}
